...
const PROGMEM char MESSAGE_HA_CURRENT[] = "{\"name\":\"%s Current\",\"unit_of_measurement\":\"A\",\"value_template\":\"{{ value_json.current }}\",\"device_class\":\"power\",\"unique_id\":\"%s_current\",\"icon\":\"mdi:counter\",";
const PROGMEM char MESSAGE_HA_POWER[] = "{\"name\":\"%s Watts\",\"unit_of_measurement\":\"w\",\"value_template\":\"{{ value_json.watios }}\",\"device_class\":\"power\",\"unique_id\":\"%s_watts\",\"icon\":\"mdi:counter\",";
const PROGMEM char MESSAGE_HA_KWH[] = "{\"name\":\"%s Kwh\",\"unit_of_measurement\":\"kwh\",\"value_template\":\"{{ value_json.kwh }}\",\"device_class\":\"power\",\"unique_id\":\"%s_kwh\",\"icon\":\"mdi:counter\",";
const PROGMEM char MESSAGE_HA_RSSI[] = "{\"name\":\"%s RSSI\",\"unit_of_measurement\":\"%%\",\"value_template\":\"{{ value_json.wifidb }}\",\"device_class\":\"power\",\"unique_id\":\"%s_rssi\",\"icon\":\"mdi:counter\",";

const PROGMEM char MESSAGE_HA_FOOTER[]  = "\"state_topic\":\"wemos/%s/power\",\"device_class\":\"power\",\"json_attributes_topic\":\"wemos/%s/power\",\"availability_topic\":\"wemos/%s/status\",\"device\":{\"identifiers\":[\"%s\"],\"name\":\"%s\",\"sw_version\":\"WemosEM 1.1\",\"model\":\"Wemos D1 Mini + SCT013\",\"manufacturer\":\"Wemos\"}}";
